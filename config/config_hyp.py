...
class DatasetPaths(object):
    VIMEO = 'data/vimeo_interp_test/data.json'
    KODAK = 'data/kodak_dataset/data.json'
...
class args(object):
    ...
    normalize_input_image = True #False  # Normalize inputs to range [-1,1]
