...
def l2(p0, p1, data_range=255.):
    return .5*np.mean((p0 / data_range - p1 / data_range)**2)
...
def dssim(p0, p1, data_range=255.):
    return (1 - compare_ssim(p0, p1, data_range=data_range, multichannel=True)) / 2.
